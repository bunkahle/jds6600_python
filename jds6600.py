...
line_end = chr(0x0d)+chr(0x0a)
# for older machines (before 2023) you might try this one:
# line_end = chr(0x0a)
...
class jds6600:
    ...
    def __sendreadcmd(self,reg,n,a):
        ...
        try:
            if self.ser.is_open == True:
                tosend=":"+c+regtxt+"="+str(n)+"."+line_end
    ...
    def __getrespondsandparse(self,reg, n, a):
        ...
        for l in range(n):
            ...
            retserial=str(retserial).rstrip()
    ...
    def DEBUG_readregister(self,register,count):
        ...
        if is_open:
            ...
            tosend=":r"+regtxt+"="+str(count)+"."+line_end
            self.ser.write(tosend.encode())
    ...
    def DEBUG_writeregister(self,register,value):
        ...
        if is_open: 
            ...
            tosend=":w"+regtxt+"="+value+"."+line_end
            self.ser.write(tosend.encode())
